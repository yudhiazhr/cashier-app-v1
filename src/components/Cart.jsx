export const Cart = () => {
  return (
    <>
      <div className="absolute right-0 flex flex-col my-8 mx-4 px-8 py-4 border min-w-[372px] rounded-xl bg-white">
        <div className="flex justify-between">
        <h1 className="mb-4 text-xl font-bold">Cart</h1>
        <button type="button" className="bg-gray-200 rounded-full p-2 w-8 h-8 inline-flex items-center justify-center hover:bg-gray-300 ">
